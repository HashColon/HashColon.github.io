...
export function getDateString(d, formatstr) {
    if (!d.valueOf())
        return "";
    ...
    return formatstr.replace(/(Kdddd|Kddd|dddd|ddd|dd|d|fffffff|ffffff|fffff|ffff|fff|ff|f|FFFFFFF|FFFFFF|FFFFF|FFFF|FFF|FF|F|gg|g|HH|H|hh|h|K|zzz|zz|z|mm|m|MMMM|MMM|MM|M|ss|s}Ktt|Kt|tt|t|yyyy|yyy|yy|y)/g, (formatchar) => {
        switch (formatchar) {
